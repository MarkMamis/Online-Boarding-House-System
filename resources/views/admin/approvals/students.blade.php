...
@section('title', 'Student Approval')
...
<div class="verification-shell">
    <div class="d-flex flex-wrap justify-content-between align-items-start gap-3 mb-4">
        <div>
            ...
            <h1 class="h4 mb-1"><i class="bi bi-person-vcard me-2"></i>Student Approval</h1>
    ...
    <div class="d-flex flex-wrap gap-2 mb-3">
        <a href="{{ route('admin.approvals.students', ['status' => 'pending']) }}" class="btn rounded-pill {{ $statusFilter === 'pending' ? 'btn-success' : 'btn-outline-secondary' }}">Pending</a>
        <a href="{{ route('admin.approvals.students', ['status' => 'approved']) }}" class="btn rounded-pill {{ $statusFilter === 'approved' ? 'btn-success' : 'btn-outline-secondary' }}">Approved</a>
        <a href="{{ route('admin.approvals.students', ['status' => 'rejected']) }}" class="btn rounded-pill {{ $statusFilter === 'rejected' ? 'btn-success' : 'btn-outline-secondary' }}">Rejected</a>
        <a href="{{ route('admin.approvals.students', ['status' => 'all']) }}" class="btn rounded-pill {{ $statusFilter === 'all' ? 'btn-success' : 'btn-outline-secondary' }}">All</a>
    </div>

    <div class="section-card">
        <div class="section-header d-flex justify-content-between align-items-center gap-2">
            <div class="fw-semibold"><i class="bi bi-list-check me-1"></i>Student Verification Queue</div>
