...
class TenantOnboarding extends Model
{
    protected $fillable = [
        ...
        'landlord_contract_signed',
        'landlord_contract_signed_at',
        'landlord_contract_signature_path',
        'landlord_contract_signature_name',
        'deposit_amount',
        'advance_amount',
        'payment_method',
        'payment_reference',
    ...
    protected $casts = [
        ...
        'landlord_contract_signed' => 'boolean',
        'landlord_contract_signed_at' => 'datetime',
